...
(function () {
  ...
  var CSS = [
    ...
    "  --c-header-bg:rgb(255 255 255);--c-header-text:12 20 34;--r-scan:rgba(0,20,60,.05);--r-glow:.12;",
    "}",
    ...
    "  --c-header-bg:rgb(16 24 36);--c-header-text:229 237 247;--r-scan:rgba(255,255,255,.04);--r-glow:.5;",
    "}",
    // ---- Ambient neon corners on the canvas (transparent app shows it) ----
    "html{background:radial-gradient(700px 300px at 92% -8%,rgb(var(--c-primary) / var(--r-glow,.4)),transparent 60%),radial-gradient(560px 280px at 6% 108%,rgb(var(--c-accent) / calc(var(--r-glow,.4) * .8)),transparent 60%),rgb(var(--c-bg));background-attachment:fixed;}",
